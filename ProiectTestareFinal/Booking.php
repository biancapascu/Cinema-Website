            ...
            <div class="booking-form-container">
                <form action="" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="29-11">November 29,2021</option>
                        <option value="30-11">November 30,2021</option>
                        <option value="01-12">December 1,2021</option>
                        <option value="02-12">December 2,2021</option>
                        <option value="03-12">December 3,2021</option>
                        <option value="04-12">December 4,2021</option>
                        <option value="05-12">December 5,2021</option>
                    </select>
